...
/**
*  Each product item contains a form, and each form contains hidden input variables item name,
*  item number, item quantity and price. A buyer is able to see product details and select quantity before buying the product.
*  When buyer decides to buy, the selected product data gets posted to process.php.
*/
<html>
  <body>
    ...
    <div class="product_wrapper">
      <table class="procut_item" border="0" cellpadding="4">
        <tr>
          <td width="70%">
            <h4>Canon EOS Rebel XS</h4>(Capture all your special moments with the Canon EOS Rebel XS/1000D DSLR camera and cherish the memories over and over again.)
          </td>
          <td width="30%">
